...
It prints out the list of rounds, the YAML configuration to be used with GoRobots and the SQL code to initialise a sqlite3 database (must be already setup with Crobots tables).